...
documentation
\cite{lorawan_packets}, from which a schematic reference was extracted and reported in
Figure \ref{img: lorawan uplink format} and \ref{img: lorawan downlink format}.\\
The focus of the comparison will be on the total size of
the packets rather than the function of each individual field, in order to analyze the overhead associated to each
protocol.
